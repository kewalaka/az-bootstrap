Describe "Grant-AzRBACRole" {
    ...
    InModuleScope 'az-bootstrap' {
        It "Calls az role assignment create with correct parameters" {
            ...
            { Grant-AzRBACRole -ResourceGroupName "rg-test" -PrincipalId "principal-id" -RoleDefinition "role-id" } | Should -Not -Throw
        ...
        It "Throws if az group show fails" {
            ...
            { Grant-AzRBACRole -ResourceGroupName "fail-rg" -PrincipalId "principal-id" -RoleDefinition "role-id" } | Should -Throw
        }
        ...
        It "Throws if az role assignment create fails" {
            ...
            # Execute and expect exception
            { Grant-AzRBACRole -ResourceGroupName "rg-test" -PrincipalId "principal-id" -RoleDefinition "role-id" } | Should -Throw
        }
